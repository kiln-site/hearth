export const floatingSurfaceClassName =
  "bg-[color-mix(in_oklab,var(--surface-overlay)_70%,transparent)] text-popover-foreground shadow-xl shadow-black/35 ring-1 ring-accent-border/18 backdrop-blur-xl"

export const floatingMotionClassName =
