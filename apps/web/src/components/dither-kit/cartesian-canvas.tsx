...
export function CartesianCanvas() {
  ...
  const { ready, chartType, configKeys, bands, seriesSpecs, y } = ctx
  ...
  // Star field disabled — keep resource-history charts calm and identical to
  // the previous recharts look aside from the dithered fill.
  const stars = useMemo(() => [] as Star[], [])
